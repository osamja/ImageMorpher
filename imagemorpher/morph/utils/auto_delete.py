...
# 0 0 * * * /usr/bin/python /app/imagemorpher/morph/utils/auto_delete.py >> /app/imagemorpher/morph/logs/auto-delete-cron.log 2>&1
...
path_of_saved_morphs = '/app/imagemorpher/morph/content/temp_morphed_images'
